...
ck:on("disconnection", function(sck) if _G.weinfo["h0"]==nil then tryWiFiConnect(false) end end)
...
sk:on("disconnection", function(sck) if _G.weinfo["h3"]==nil then tryWiFiConnect(false) end end)
